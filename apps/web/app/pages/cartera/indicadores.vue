...
<template>
  <div class="space-y-8">
    ...
    <div v-if="cargando && !carteraStore.indicadores" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <div v-for="i in 6" :key="i" class="space-y-2 rounded-lg border border-neutral-200 p-4 dark:border-neutral-800">
    ...
    <template v-else-if="carteraStore.indicadores">
      ...
      <div v-if="rollRateFilas.length > 0" class="rounded-lg border border-neutral-200 p-4 dark:border-neutral-800">
