...
export const ERROR_CODES = {
  ...
  // guard_inmueble_inactivar_con_saldo (hallazgo QA f2-17) — estado=inactivo
  // rechazado mientras v_cargo_saldo tenga algún monto_pendiente > 0.
  INMUEBLE_SALDO_PENDIENTE: 'INMUEBLE_SALDO_PENDIENTE',
