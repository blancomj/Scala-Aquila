...
| **GAP-19** | Reapertura de "todo agrega en un único concepto `CUOTA_ADMIN`" (línea 424) — motivada por `Docs/Motor presupuestal/AQUILA_SAAS_E16_...md`: arts. 25/31 Ley 675 exigen destinación sectorial y fuentes de financiación distintas de la cuota, algo irrepresentable con un solo concepto | Motor Presupuestal | **Adoptado**: presupuesto multi-componente (E-16 §5-§9). Extiende `presupuesto_rubros`/`conceptos`; no bifurca esquema (E-16 REC-001). Diseño físico pendiente — ver §12.1/§12.4 |
